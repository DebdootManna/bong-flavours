  ...
  const menuItems = [
    {
      ...
      price: '₹400',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/d1e67d9c2b4a491671e811f1e68f8bf01eabfb14?width=590'
    },
    {
      name: 'Fish Curry (2pcs)',
      price: '₹270',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/b1c875b81eb62c4300dbc3f32558ebf90bcc4201?width=590'
    },
    {
      name: 'Aloo Dum',
      price: '₹150',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/472ff2101e58ac22d6afad96149805e835c76311?width=590'
    },
    {
      name: 'Egg Kathi Roll',
      price: '₹99',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/aa45e90ba1cd0c1c6a06a672ce99e59530a42e7d?width=590'
    }
  ]
    ...
    <main className="min-h-screen bg-[#3C1518]">
      ...
      <nav className="flex justify-between items-center px-6 md:px-12 py-4 md:py-6">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link href="/" className="text-[#D22020] text-lg underline font-instrument-sans">Home</Link>
          <Link href="/gallery" className="text-white text-lg font-instrument-sans hover:text-[#D22020]">Gallery</Link>
          <Link href="/booking" className="text-white text-lg font-instrument-sans hover:text-[#D22020]">Booking</Link>
        </div>

        <div className="flex items-center gap-4 border border-white rounded-full px-4 py-2">
          <Link href="/login" className="text-white text-base md:text-lg underline font-instrument-sans">Login</Link>
          <Link href="/signup" className="text-white text-base md:text-lg underline font-instrument-sans">Sign Up</Link>
        </div>
      </nav>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-start px-6 md:px-24 py-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          >
            Taste the <span className="text-3xl md:text-5xl" style={{fontFamily: 'Playwrite US Trad, cursive'}}>Authentic</span>
            <br />
            <span className="text-5xl md:text-7xl lg:text-8xl">Bengali Heritage</span>
          </motion.h1>
          ...
          >
            From traditional fish curry to aromatic biryani, experience the rich flavours of Bengal crafted with authentic recipes and the finest ingredients.
          </motion.p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <p className="text-white text-xl md:text-2xl leading-relaxed font-albert-sans mb-8">
              Indulge in the authentic taste of Bengal with our traditional recipes, lovingly passed down through generations. 
              Each dish on our menu is crafted to bring you closer to the vibrant stories and rich flavours of Bengali culture. 
              From Kolkata-style biryani and spicy rolls to homely thalis and sweet rasgullas, Bong Flavours delivers a diverse 
              experience that honours tradition while inviting you to explore new tastes. Experience true Bengali hospitality—where 
              every plate tells a story of heritage and flavour.
            </p>
            <div className="flex flex-col md:flex-row gap-4 text-white text-lg">
              <div>
                <p className="font-albert-sans">5th Eve, Colombo Road, Galle.</p>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#3C1518]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-red-500 text-base font-bold tracking-wider uppercase font-prata mb-4">Slice of Heaven</p>
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="h-0.5 w-24 bg-[#D22020]"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-white font-albert-sans">Essence of Traditional Flavors</h2>
              <div className="h-0.5 w-24 bg-[#D22020]"></div>
            </div>
          </div>
              ...
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="p-6 text-center">
                    <h3 className="text-[#F2F3AE] text-xl font-poppins uppercase tracking-wide mb-2">{item.name}</h3>
                    <p className="text-[#A44200] text-lg font-bold font-poppins mb-4">{item.price}</p>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#3C1518]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-red-500 text-base font-bold font-prata mb-4">Feast your eyes</p>
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="h-0.5 w-16 bg-red-500"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-white font-albert-sans">Our Special Environment</h2>
              <div className="h-0.5 w-16 bg-red-500"></div>
            </div>
          </div>
          ...
          <div className="bg-white/10 rounded-2xl p-8 md:p-12">
            <div className="flex flex-col items-center text-center">
              ...
              />
              <h3 className="text-white text-3xl font-bold font-albert-sans mb-8">Foundation</h3>
              <p className="text-white text-xl md:text-2xl leading-relaxed max-w-3xl font-albert-sans">
                Bong Flavours is the vision of Kakoli Mallick, who has passionately blended her Bengali heritage with a love for 
                culinary excellence. As the owner and founder, Kakoli brings traditional recipes from her family kitchen to the heart 
                of Vadodara, ensuring each dish reflects the warmth, stories, and authenticity of Bengal. Guided by her expertise and 
                dedication, she leads the team at Bong Flavours, curating a menu that stays true to its roots while appealing to both 
                nostalgic and new palates. Under her stewardship, Bong Flavours stands as a testament to handcrafted taste and heartfelt hospitality.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 px-6 md:px-12">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <p className="text-[#D22020] text-base font-bold tracking-wider uppercase font-poppins mb-4">discount</p>
          <h2 className="text-white text-4xl md:text-5xl font-bold tracking-wider font-poppins mb-4">Upcoming Events</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-8">
            ...
            <div className="flex flex-wrap gap-6 md:gap-8 text-white font-instrument-sans text-lg">
              <Link href="/" className="hover:text-[#D22020]">Home</Link>
          ...
          <div className="border-t border-white/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-white text-sm font-instrument-sans">© 2024 Bong Flavours. All rights reserved.</p>
