    ...
    <main className="min-h-screen bg-[#3C1518]">
      ...
      <div className="bg-[#3C1518] px-6 md:px-12 py-12">
        ...
        <div className="flex flex-col items-center mb-12">
          <h1 className="text-white text-4xl md:text-5xl font-bold font-['Poppins'] tracking-tight mb-4">
            Menu
          </h1>
          <div className="flex items-center gap-2">
            <div className="w-12 h-0.5 bg-[#D22020]"></div>
            <svg
              className="w-5 h-5 text-[#D22020]"
              viewBox="0 0 18 22"
              fill="currentColor"
            >
              <path
          ...
          {menuSections.map((section, sectionIndex) => (
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <h2 className="text-white text-3xl md:text-4xl font-bold font-['Poppins']">
                  {section.title}
                </h2>
                <div className="hidden md:block w-32 h-0.5 bg-white"></div>
              </div>
              ...
              {/* Section Content */}
              <div
                className={`flex flex-col ${section.imagePosition === "left" ? "lg:flex-row" : "lg:flex-row-reverse"} gap-8 lg:gap-12 items-center max-w-7xl mx-auto`}
              >
                {/* Section Image */}
                    ...
                    <div key={itemIndex} className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start gap-2 mb-1">
                          <h3 className="text-white text-xs md:text-sm font-['Poppins'] tracking-wide">
                            {item.name}
                          </h3>
                          <svg
                            className="w-3 h-3 text-white flex-shrink-0 mt-1"
                            viewBox="0 0 10 12"
                            fill="currentColor"
                          >
                            <path
                        ...
                        <div className="flex items-start gap-1">
                          ...
                          <span className="text-white text-xs font-['Poppins'] whitespace-nowrap">
                            {item.price}
                          </span>
                        </div>
